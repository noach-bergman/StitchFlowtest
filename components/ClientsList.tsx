      ...
      <div className="flex flex-col md:flex-row gap-5 justify-between items-center bg-white p-6 rounded-[2rem] md:rounded-3xl shadow-sm border border-rose-100">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <button 
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-[#fee9f3] text-slate-700 px-6 py-3 rounded-xl font-black text-sm hover:bg-slate-200 transition-all active:scale-95"
          >
