...
import { resolvePrinterIdFromRequest, setDefaultPrinter } from '../../../server/printersHandlers.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await setDefaultPrinter({ store, printerId });
    ...
    if (code === 'default_printer_disabled') {
